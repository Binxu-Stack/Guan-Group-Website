...
import os
print("Creating publication.html...")
os.system("./All_publications/bibtex2html.py ./All_publications/all.bib base.html publications.html")
print("Creating publication.html finished.")

print("Copying files to ../2-view")
cmd = """
[ -d ../2-view ] || mkdir ../2-view
cp index.html people.html contact.html publications.html ../2-view
